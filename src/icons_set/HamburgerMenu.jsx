function HamburgerMenu(props) {
    ...
    return <>
        <svg xmlns="http://www.w3.org/2000/svg" width={props.width ? props.width : "16"} height={props.height ? props.width : "16"} fill="currentColor" className="bi bi-list-ul" viewBox="0 0 16 16">
